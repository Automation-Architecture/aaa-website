...
const articleSchema = {
  ...
  description: "Zapier connects apps. An AIOS runs your business. Compare scope, intelligence, context, and compounding — and see which approach fits your operation.",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "AIOS vs Zapier", item: `${SITE_URL}/aios-vs-zapier` },
  ],
};

export function AiosVsZapierView() {
  return (
    <>
      ...
      <article className="mx-auto max-w-3xl px-4 py-16">
        ...
        <h2 id="zapier-is-a-good-tool" className="mt-12 text-2xl font-bold text-brand-teal">
        ...
        <h2 id="the-ceiling-youve-probably-hit" className="mt-12 text-2xl font-bold text-brand-teal">
        ...
        <p className="mt-4 text-brand-teal/80">You start noticing the gaps:</p>
        <ul className="mt-2 list-disc pl-6 space-y-2 text-brand-teal/80">
          <li>A Zap fires, but the action it takes isn&#39;t the right one because the situation changed since you set the rule.</li>
          <li>You&#39;re spending hours maintaining workflows that break when an API updates or a field name changes.</li>
          <li>You have automation, but you still log into seven platforms every morning to understand what&#39;s going on.</li>
          <li>Nothing compounds. The Zap you built six months ago is exactly as capable as the day you made it.</li>
        </ul>
        <p className="mt-4 text-brand-teal/80">
        ...
        <h2 id="the-missing-layer-business-context" className="mt-12 text-2xl font-bold text-brand-teal">
        ...
        <h2 id="three-layers-zapier-cant-provide" className="mt-12 text-2xl font-bold text-brand-teal">
        ...
        <h3 className="mt-8 text-xl font-bold text-brand-teal">1. Business Context Data Engine</h3>
        <p className="mt-4 text-brand-teal/80">
        ...
        <h3 className="mt-8 text-xl font-bold text-brand-teal">2. Dashboard Intelligence</h3>
        <p className="mt-4 text-brand-teal/80">
        ...
        <h3 className="mt-8 text-xl font-bold text-brand-teal">3. Automated Task Management</h3>
        <p className="mt-4 text-brand-teal/80">
        ...
        <p className="mt-4 text-brand-teal/80">Zapier workflows are flat. An AIOS is a loop.</p>
        ...
        <p className="mt-4 text-brand-teal/80"><strong>Zapier or Make is right if:</strong></p>
        <ul className="mt-2 list-disc pl-6 space-y-2 text-brand-teal/80">
          <li>You need simple app-to-app connections</li>
          <li>Your automation needs are limited to a few specific workflows</li>
          <li>You have the technical comfort to build and maintain Zaps yourself</li>
          <li>You don&#39;t need the system to understand your business context</li>
        </ul>
        <p className="mt-6 text-brand-teal/80"><strong>An AIOS is right if:</strong></p>
        <ul className="mt-2 list-disc pl-6 space-y-2 text-brand-teal/80">
          <li>You&#39;ve built automations but they don&#39;t talk to each other</li>
          <li>You need the system to reason, not just react</li>
          <li>You want your automation to get smarter over time</li>
          <li>You&#39;re spending more time maintaining workflows than benefiting from them</li>
          <li>You want your entire operation — not just individual tasks — to run with less of your time</li>
        </ul>
        <p className="mt-4 text-brand-teal/80">
        ...
        <h2 id="how-we-build-it" className="mt-12 text-2xl font-bold text-brand-teal">
          How We Build It
        </h2>
        <p className="mt-4 text-brand-teal/80">
          The{" "}
        ...
        <h2 id="see-it-in-action" className="mt-12 text-2xl font-bold text-brand-teal">
          See It in Action
        </h2>
        <p className="mt-4 text-brand-teal/80">
