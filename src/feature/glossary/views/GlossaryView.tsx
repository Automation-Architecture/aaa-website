      ...
      <article className="mx-auto max-w-3xl px-4 py-16">
        ...
        <div className="mt-8">
          ...
          <GlossaryTerm id="ai-operating-system" term="AI Operating System">
            <p>See <strong>AIOS</strong> above. The terms are interchangeable.</p>
            <p className="mt-3">
              <Link href={RouteNames.Solution} className="text-brand-teal underline underline-offset-2 hover:text-brand-lime transition-colors">
                Learn more on the Solution page
              </Link>
          ...
          <GlossaryTerm id="ai-blueprint" term="AI Blueprint">
            <p>
              ...
              and goals. The Blueprint is yours to keep regardless of whether
              you engage further.
            </p>
            <p className="mt-3">
          ...
          <GlossaryTerm id="bandwidth-inversion" term="Bandwidth Inversion">
            <p>
              ...
              70-80% growth). It&apos;s the measurable outcome of a working AIOS.
            </p>
            <p className="mt-3">
              <Link href={RouteNames.Solution} className="text-brand-teal underline underline-offset-2 hover:text-brand-lime transition-colors">
                Learn more on the Solution page
          ...
          <GlossaryTerm id="agent-to-agent-economy" term="Agent-to-Agent Economy">
            ...
            <p className="mt-3">
              <Link href={RouteNames.Home} className="text-brand-teal underline underline-offset-2 hover:text-brand-lime transition-colors">
