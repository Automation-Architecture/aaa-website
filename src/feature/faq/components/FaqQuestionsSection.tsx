    ...
    <FaqAccordion>
      ...
      <FaqAccordionItem id="what-industries-benefit-most-from-ai-automation" question="23. What industries benefit most from AI automation?">
        <p>
          ...
          deployed across{" "}
          <Link href={RouteNames.IndustryAgencies} className="text-brand-teal underline underline-offset-2 hover:text-brand-lime transition-colors">
            agencies
          </Link>
          ,{" "}
          <Link href={RouteNames.IndustryCoaching} className="text-brand-teal underline underline-offset-2 hover:text-brand-lime transition-colors">
            coaching businesses
          </Link>
          ,{" "}
          <Link href={RouteNames.IndustryEcommerce} className="text-brand-teal underline underline-offset-2 hover:text-brand-lime transition-colors">
            ecommerce
          </Link>
          ,{" "}
          <Link href={RouteNames.IndustrySaas} className="text-brand-teal underline underline-offset-2 hover:text-brand-lime transition-colors">
            SaaS
          </Link>
