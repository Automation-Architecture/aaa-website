...
export function ProblemHeroSection() {
  return (
    <section className="relative overflow-visible border-b border-brand-gray2 bg-brand-surface px-6 pb-8 pt-6 tablet:px-10 tablet:pb-10 tablet:pt-9 desktop:min-h-94.25 desktop:px-10 desktop:pt-12 min-[1440px]:px-17.5 min-[1440px]:pt-19.75">
      ...
      <aside className="mt-6 rounded-[0.625rem] bg-brand-black px-6 py-6 tablet:px-8 tablet:py-7 desktop:absolute desktop:-bottom-10 desktop:right-0 desktop:z-20 desktop:mt-0 desktop:w-[min(56.25rem,52%)] desktop:rounded-l-[0.625rem] desktop:rounded-r-none desktop:px-10 desktop:py-8 min-[1440px]:-bottom-12 min-[1440px]:px-25 min-[1440px]:py-12">
        ...
        <p className="mt-4 max-w-170.5 text-[1rem] leading-[1.4] text-brand-divider tablet:text-[1.0625rem] desktop:text-[clamp(0.9375rem,1.2vw,1.25rem)]">
          ...
          tools available and none connected to each other, the instinct to
          adopt AI is right but the infrastructure is missing. The path out
          isn&apos;t more tools - it&apos;s a unified system built around your
          business context.
        </p>
      </aside>
    </section>
