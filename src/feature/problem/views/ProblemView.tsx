...
const articleSchema = {
  ...
  "@type": "Article",
  headline: "The Operator Trap — Why Small Business Founders Are Stuck in Operations",
  description: "The Operator Trap is a pattern where 80% of a founder's working hours go to operational maintenance, leaving only 20% for growth work. Here's why it happens and what breaks it.",
  ...
  keywords: ["operator trap", "small business operations", "founder burnout", "operational maintenance", "business automation need", "AI for small business"],
};
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 2, name: "The Operator Trap", item: `${SITE_URL}/problem` },
  ],
};
    ...
    <>
      ...
      <article className="mx-auto max-w-3xl px-4 py-16">
        ...
        <section id="section-the-pattern" className="mt-12">
          <h2 id="the-pattern" className="text-2xl font-bold text-brand-teal">
            The Pattern
          </h2>
          ...
          <p className="mt-4 text-brand-teal/80">They&rsquo;re not alone.</p>
        </section>

        <section id="section-the-80-20-split" className="mt-12">
          <h2 id="the-80-20-split" className="text-2xl font-bold text-brand-teal">
            The 80/20 Split
          </h2>
          <p className="mt-6 text-brand-teal/80">
        ...
        <section id="section-the-trajectory" className="mt-12">
          <h2 id="the-trajectory" className="text-2xl font-bold text-brand-teal">
            The Trajectory
          </h2>
          <p className="mt-6 text-brand-teal/80">
        ...
        <section id="section-the-margin-pressure" className="mt-12">
          <h2 id="the-margin-pressure" className="text-2xl font-bold text-brand-teal">
            The Margin Pressure
          </h2>
          <p className="mt-6 text-brand-teal/80">
        ...
        <section id="section-the-overwhelm-is-real" className="mt-12">
          <h2 id="the-overwhelm-is-real" className="text-2xl font-bold text-brand-teal">
          ...
          <QuotableStatement text="Tools without architecture don't compound. They accumulate.">
            <p>Tools without architecture don&rsquo;t compound. They accumulate.</p>
          </QuotableStatement>
        </section>

        <section id="section-the-ceiling" className="mt-12">
          <h2 id="the-ceiling" className="text-2xl font-bold text-brand-teal">
            The Ceiling
          </h2>
          <blockquote className="mt-6 border-l-4 border-brand-lime pl-4 italic text-brand-gray">
            &ldquo;I&rsquo;ve tried using AI in my business and hit a wall.&rdquo;
          </blockquote>
          <p className="mt-6 text-brand-teal/80">
        ...
        <section id="section-the-bridge" className="mt-12">
          <h2 id="the-bridge" className="text-2xl font-bold text-brand-teal">
            The Bridge
          </h2>
          <p className="mt-6 text-brand-teal/80">
        ...
        <div className="mt-12">
          <RelatedLinks
            links={[
              { label: "The system that fixes it →", href: RouteNames.Solution },
