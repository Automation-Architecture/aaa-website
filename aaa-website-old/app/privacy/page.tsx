    ...
    <>
      ...
      <article className="mx-auto max-w-3xl px-4 py-16 tablet:py-20">
        ...
        <Section id="what-we-collect" className="mt-12">
          ...
          <h3 className="mt-6 text-lg font-semibold text-brand-teal">
            ...
            <ResponsiveTable
              ...
              rows={[
                [
                  ...
                  "Form submissions (business details, goals)",
                ],
                [
                ...
                [
                  "Understand site traffic and improve content",
        ...
        <Section id="third-party-services" className="mt-12">
          ...
          <div className="mt-4">
            {/* Desktop table with links — can't use ResponsiveTable for linked cells */}
            ...
            <ResponsiveTable
              ...
              rows={[
                ...
                [
                  ...
                  "Up to 2 years",
                  "Google (only if consent granted)",
                ],
              ]}
            />
          </div>
        ...
        <Section id="your-rights" className="mt-12">
          ...
          <ul className="mt-3 list-disc pl-6 space-y-1 text-brand-teal/80">
            ...
            <li>
              <strong>Object</strong> to or restrict how we use your information
            </li>
            <li>
              <strong>Withdraw consent</strong> for cookie tracking at any time
            </li>
          </ul>
        ...
        <Section id="data-retention" className="mt-12">
          ...
          <ul className="mt-4 list-disc pl-6 space-y-2 text-brand-teal/80">
            <li>
              <strong>Blueprint form data:</strong> Retained in HubSpot for the
              duration of the business relationship, or until you request
              deletion.
            </li>
            <li>
              <strong>Analytics data:</strong> GA4 retains data for 14 months
              (Google&apos;s default).
            </li>
            <li>
              <strong>Consent cookie:</strong> 365 days, then re-prompts.
            </li>
          </ul>
        </Section>
        ...
        <Section id="contact" className="mt-12">
          ...
          <p className="mt-1 text-brand-teal/80">
            ...
            <Link href="/" className="underline hover:text-brand-lime transition-colors">
