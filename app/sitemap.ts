...
const BASE_URL = "https://automationarchitecture.ai";
...
export default function sitemap(): MetadataRoute.Sitemap {
  return [
    ...
    { url: `${BASE_URL}/how-it-works`, lastModified: new Date("2026-03-18"), changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/use-cases`, lastModified: new Date("2026-03-18"), changeFrequency: "monthly", priority: 0.9 },
    { url: `${BASE_URL}/problem`, lastModified: new Date("2026-03-18"), changeFrequency: "monthly", priority: 0.8 },
    { url: `${BASE_URL}/about`, lastModified: new Date("2026-03-18"), changeFrequency: "monthly", priority: 0.7 },
    ...
    { url: `${BASE_URL}/blueprint`, lastModified: new Date("2026-03-18"), changeFrequency: "monthly", priority: 0.9 },
    ...
    { url: `${BASE_URL}/privacy`, lastModified: new Date("2026-03-18"), changeFrequency: "yearly", priority: 0.3 },
    { url: `${BASE_URL}/terms`, lastModified: new Date("2026-03-18"), changeFrequency: "yearly", priority: 0.3 },
  ];
}
