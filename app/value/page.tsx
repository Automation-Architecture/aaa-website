    ...
    <>
      <JsonLd
        data={{
          ...
          image: `${SITE_URL}/images/value-og.jpg`,
      ...
      <article className="mx-auto max-w-3xl px-4 py-16">
        ...
        <h2 id="the-cost-of-staying-stuck" className="mt-12">
          The Expense You Can&apos;t See
        </h2>
        ...
        {/* The Bandwidth Math */}
        <h2 id="the-bandwidth-math" className="mt-12">
          The Bandwidth Math
        </h2>
        ...
        <p className="mt-4">Let&apos;s make that real.</p>
        ...
        <h2 id="the-time-savings" className="mt-12">
          What Those Hours Are Worth
        </h2>
        ...
        <p className="mt-4">But here&apos;s the simple math:</p>
        ...
        {/* The Compound Effect */}
        <h2 id="the-compound-effect" className="mt-12">
          The Compound Effect
        </h2>
        ...
        <h2 id="three-things-we-measure" className="mt-12">
          Three Things We Measure
        </h2>
        ...
        <h3 className="mt-6 font-semibold">Away-from-Desk Autonomy</h3>
        ...
        <h3 className="mt-6 font-semibold">Task Automation Percentage</h3>
        ...
        <h3 className="mt-6 font-semibold">Revenue per Person</h3>
        ...
        <section className="mt-12">
          <h3 className="font-semibold">What This Looks Like in Practice</h3>
          ...
          <ul className="mt-4 list-disc pl-6 space-y-2">
            ...
            <li>
              ...
              that reduced{" "}
              <strong>15-20 hours per week</strong> of manual prospecting to zero
            </li>
            <li>
              <Link href="/use-cases" className="text-brand-teal underline underline-offset-2 hover:text-brand-lime transition-colors">
                Data Dashboards
        ...
        {/* The Real Question */}
        <section className="mt-12">
          <h3 className="font-semibold">The Real Question</h3>
        ...
        {/* Important Context */}
        <section className="mt-12">
          <h3 className="">Important Context</h3>
        ...
        <div className="mt-12">
          <RelatedLinks
            links={[
              { label: "The cost of the Operator Trap", href: "/problem" },
              { label: "How the system works", href: "/solution" },
